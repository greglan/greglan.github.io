...
* BPP: Bounded error Probabilistic Polynomial time problems (1970s). Problems that can be solved in polynomial time by probabilistic Turing machines. Boud: probability that the answer is correct is greater that 2/3. Formally:
